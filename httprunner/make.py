...
"""
# 修改源码 用例集中的case可以按顺序执行
# pytest_files_run_set: Set = set()
pytest_files_run_list: List = list()
...
def make_testsuite(testsuite: Dict) -> NoReturn:
    ...
    for testcase in testsuite["testcases"]:
        ...
        pytest_files_run_list.append(testcase_pytest_path)
...
def __make(tests_path: Text) -> NoReturn:
    ...
    for test_file in test_files:
        if test_file.lower().endswith("_test.py"):
            ...
            pytest_files_run_list.append(test_file)
            continue
...
def main_make(tests_paths: List[Text]) -> List[Text]:
    ...
    pytest_files = sorted(set(pytest_files_run_list), key=pytest_files_run_list.index)
    return pytest_files
